...
@Stable
public class ServerConnectionBottomSheetState internal constructor(
...
@Composable
public fun rememberServerConnectionBottomSheetState(
    bottomSheetState: ManagedModalBottomSheetState = rememberManagedModalBottomSheetState()
): ServerConnectionBottomSheetState = remember(bottomSheetState) {
    ServerConnectionBottomSheetState(bottomSheetState = bottomSheetState)
}
