...
public actual fun rememberWindowTitleBarState(value: WindowTitleBarStateModel): WindowTitleBarStateHolder =
    remember(value) {
        JvmWindowTitleBarState(
            initialValue = value
        )
    }

internal class JvmWindowTitleBarState internal constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is JvmWindowTitleBarState) return false
    ...
    override fun toString(): String =
        "JvmWindowTitleBarState(mutableTitle=$mutableTitleBar, mutex=$mutex, title=$titleBar)"
}
