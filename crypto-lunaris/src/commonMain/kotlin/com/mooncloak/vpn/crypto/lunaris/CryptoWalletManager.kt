...
public interface CryptoWalletManager : AutoCloseable {
     ...
     *
     * @param [seedPhrase] The BIP-39 mnemonic seed phrase (e.g., 12 or 24 words).
     *
     ...
     */
    public suspend fun restoreWallet(seedPhrase: String, password: String? = null): CryptoWallet
