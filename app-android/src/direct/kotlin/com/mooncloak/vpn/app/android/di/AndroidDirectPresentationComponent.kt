...
@Component
@PresentationScoped
internal abstract class AndroidDirectPresentationComponent internal constructor(
...
): AndroidPresentationComponent = AndroidDirectPresentationComponent::class.create(
    applicationComponent = applicationComponent,
