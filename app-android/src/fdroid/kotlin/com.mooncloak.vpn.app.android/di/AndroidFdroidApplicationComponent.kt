...
@Component
@Singleton
internal abstract class AndroidFdroidApplicationComponent internal constructor(
...
): AndroidFdroidApplicationComponent = AndroidFdroidApplicationComponent::class.create(
    applicationContext = applicationContext,
