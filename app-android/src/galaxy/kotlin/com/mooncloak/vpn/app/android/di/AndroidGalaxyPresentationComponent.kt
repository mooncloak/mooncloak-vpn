...
@Component
@PresentationScoped
internal abstract class AndroidGalaxyPresentationComponent internal constructor(
...
): AndroidPresentationComponent = AndroidGalaxyPresentationComponent::class.create(
    applicationComponent = applicationComponent,
